		...
		>
			<div className={styles.container}>
				...
				>
					...
					<a
						href='mailto: preetbhardwaj517@gmail.com'
						aria-label='email'
						target='_blank'
						rel='noreferrer'
					>
					...
					<a
						href='https://github.com/PreetS123'
						aria-label='GitHub'
						rel='noreferrer'
						target='_blank'
					>
					...
					<a
						href='https://www.linkedin.com/in/preeti-sharma123/'
						aria-label='Linkedin'
						target='_blank'
						rel='noreferrer'
					>
			...
			>
				Designed and build by Preeti Sharma , 2022 All rights
				reserved.
			</div>
		</footer>
	);
